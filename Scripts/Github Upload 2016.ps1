...
$filePath   = 'C:\Temp\Windows Server 2016 14393.txt'
$remotePath = 'Windows Server 2016 14393.txt'
$commitMessage = "Windows Server 2016 14393 Updatelist $(Get-Date -Format yyyy-MM-dd_HH-mm)"
$branch = 'main'
$owner = 'Alitai12'
...
$ws2022Details = $Driver.FindElementByXPath("//details[summary[contains(., 'Windows Server 2016 (OS build 14393)')]]")
...
$gaLines = $lines | Where-Object { $_ -like "LTSB*" }
