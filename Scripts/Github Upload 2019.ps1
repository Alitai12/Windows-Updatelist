...
$filePath   = 'C:\Temp\Windows Server 2019 17763.txt'
$remotePath = 'Windows Server 2019 17763.txt'
$commitMessage = "Windows Server 2019 17763 Updatelist $(Get-Date -Format yyyy-MM-dd_HH-mm)"
$branch = 'main'
$owner = 'Alitai12'
...
$ws2022Details = $Driver.FindElementByXPath("//details[summary[contains(., 'Windows Server 2019 (OS build 17763)')]]")
