...
$filePath   = 'C:\Temp\Windows Server 2022 20348.txt'
$remotePath = 'Windows Server 2022 20348.txt'
$commitMessage = "Windows Server 2022 20348 Updatelist $(Get-Date -Format yyyy-MM-dd_HH-mm)"
$branch = 'main'
$owner = 'Alitai12'
...
$ws2022Details = $Driver.FindElementByXPath("//details[summary[contains(., 'Windows Server 2022 (OS build 20348)')]]")
