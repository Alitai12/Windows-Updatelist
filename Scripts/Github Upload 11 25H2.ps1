...
$filePath   = 'C:\Temp\Windows 11 25H2 26200.txt'
$remotePath = 'Windows 11 25H2 26200.txt'
$commitMessage = "Windows 11 25H2 26100 Updatelist $(Get-Date -Format yyyy-MM-dd_HH-mm)"
$branch = 'main'
$owner = 'Alitai12'
