...
$filePath   = 'C:\Temp\Windows 11 23H2 22631.txt'
$remotePath = 'Windows 11 23H2 22631.txt'
$commitMessage = "Windows 11 23H2 22631 Updatelist $(Get-Date -Format yyyy-MM-dd_HH-mm)"
$branch = 'main'
$owner = 'Alitai12'
...
$ws2022Details = $Driver.FindElementByXPath("//details[summary[contains(., 'Version 23H2 (OS build 22631)')]]")
...
$gaLines = $lines | Where-Object { $_ -like "General Availability Channel*" }
